export const SKILLS_DATA = [
  {
    ...
    skills: [
      ...
      { name: "SQL", imageUrl: "assets/images/skills/sql.webp" },
      { name: "HTML", imageUrl: "assets/images/skills/html.webp" },
      { name: "CSS", imageUrl: "assets/images/skills/css.webp" },
      { name: "Javascript", imageUrl: "assets/images/skills/javascript.webp" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "JavaFX", imageUrl: "assets/images/skills/javafx.webp" },
      { name: "Spring", imageUrl: "assets/images/skills/spring.webp" },
      { name: "Quarkus", imageUrl: "assets/images/skills/quarkus.webp" },
      { name: "Jakarta EE", imageUrl: "assets/images/skills/jakartaee.webp" },
      { name: "Hibernate", imageUrl: "assets/images/skills/hibernate.webp" },
    ],
  },
  {
    name: "TESTS",
    skills: [
      ...
      { name: "Rest Assured", imageUrl: "assets/images/skills/restassured.webp" }
    ],
  },
  {
    name: "DB",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "JWT", imageUrl: "assets/images/skills/jwt.webp" },
    ],
  },
  {
    name: "DEVOPS_TOOLS",
    skills: [
      ...
      { name: "Maven", imageUrl: "assets/images/skills/maven.webp" },
      { name: "Postman", imageUrl: "assets/images/skills/postman.webp" },
    ],
  },
  {
    name: "IDE",
    skills: [
      ...
      { name: "VS Code", imageUrl: "assets/images/skills/vscode.webp" },
    ],
  },
  {
    name: "METHODOLOGIES",
